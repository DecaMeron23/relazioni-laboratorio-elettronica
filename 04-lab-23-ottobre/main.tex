...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\linewidth]{immagini/ring-oscillator/plot-Freq-Res.png}
...
Il modello circuitale del divisore in frequenza a \autoref{fig:divisione-in-frequenza-schematico} è caratterizzato dal prelevare l'uscita negata $\overline{\mathrm{Q}}$ e portarla all'ingresso D. In aggiunta il segnale di clock è portato al rispettivo pin.
